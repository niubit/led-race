...
byte leader=0;
byte loop_max=6; //total laps race
...
void setup() {
  ...
  set_ramp(12,PIX_COMIENZO_SUBIDA,PIX_FIN_SUBIDA,PIX_FIN_SUBIDA);
  set_ramp(12,PIX_COMIENZO_BAJADA,PIX_COMIENZO_BAJADA,PIX_FIN_BAJADA);
...
void reset_vars() {
  loop1=0;
  loop2=0;
  dist1=NPIXELS; // Partimos con una vuelta por si al salir volvemos atrás por una rampa
  dist2=NPIXELS; // Partimos con una vuelta por si al salir volvemos atrás por una rampa
  speed1=0;
  speed2=0;
  timestamp=0;
}
