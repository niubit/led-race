...
void reset_vars() {
  loop1=0;
  loop2=0;
  dist1=MAXLED; // Partimos con una vuelta por si al salir volvemos atrás por una rampa
  dist2=MAXLED; // Partimos con una vuelta por si al salir volvemos atrás por una rampa
  speed1=0;
  speed2=0;
  timestamp=0;
}
